...
public class StudentDao extends AbstractDao<Student, Long> {
    ...
    public static class Properties {
        ...
        public final static Property Student_age = new Property(2, Integer.class, "student_age", false, "STUDENT_AGE");
    }
    ...
    public StudentDao(DaoConfig config, AndroidDaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"STUDENT\" (" + //
                ...
                "\"STUDENT_AGE\" INTEGER);"); // 2: student_age
    }
    ...
    protected final void bindValues(DatabaseStatement stmt, Student entity) {
        ...
        Integer student_age = entity.getStudent_age();
        if (student_age != null) {
            stmt.bindLong(3, student_age);
        }
    }
    ...
    public Student readEntity(Cursor cursor, int offset) {
        Student entity = new Student( //
            ...
            cursor.isNull(offset + 2) ? null : cursor.getInt(offset + 2) // student_age
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Student entity, int offset) {
        ...
        entity.setStudent_age(cursor.isNull(offset + 2) ? null : cursor.getInt(offset + 2));
     }
